	...
	({ size = 24, color = 'currentColor', strokeWidth = 2, className = '' }, ref) => {
		...
		return (
			...
			>
				...
				/>
				<motion.path className="slash" d="m2 2 20 20" initial={{ pathLength: 1, opacity: 1 }} />
				<motion.path className="bell" d="M8.668 3.01A6 6 0 0 1 18 8c0 2.687.77 4.653 1.707 6.05" />
			</motion.svg>
		)
	}
)
