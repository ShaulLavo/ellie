...
export function CodeComparison({
	...
	const [highlightedBefore, setHighlightedBefore] =
		useState('')
	const [highlightedAfter, setHighlightedAfter] =
		useState('')
	...
	useEffect(() => {
		if (highlightedBefore || highlightedAfter) {
			setHasLeftFocus(
				highlightedBefore.includes('class="line focused"')
			)
			setHasRightFocus(
				highlightedAfter.includes('class="line focused"')
			)
		}
