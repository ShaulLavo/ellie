...
const SchemaDisplayContext =
	createContext<SchemaDisplayContextType>({
		method: 'GET',
		path: ''
	})
...
export type SchemaDisplayMethodProps = ComponentProps<
	typeof Badge
>
...
export type SchemaDisplayRequestProps = ComponentProps<
	typeof Collapsible
>
