...
export type StreamingMessageResponseProps = Omit<MessageResponseProps, 'children'> & {
	children: string
	isStreaming: boolean
}
...
export const StreamingMessageResponse = ({
	...
	const animatedText = useAnimatedText(children, isStreaming)
	return <MessageResponse {...props}>{animatedText}</MessageResponse>
}
