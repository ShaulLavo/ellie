...
import {
	Circle as CircleSmallIcon,
	GenderMale as MarsIcon,
	GenderNeuter as MarsStrokeIcon,
	GenderNonbinary as NonBinaryIcon,
	Pause as PauseIcon,
	Play as PlayIcon,
	GenderTransgender as TransgenderIcon,
	GenderIntersex as VenusAndMarsIcon,
	GenderFemale as VenusIcon
...
export type VoiceSelectorTriggerProps = ComponentProps<
	typeof DialogTrigger
>

export const VoiceSelectorTrigger = (
	props: VoiceSelectorTriggerProps
) => <DialogTrigger {...props} />
...
export type VoiceSelectorDialogProps = ComponentProps<
	typeof CommandDialog
>

export const VoiceSelectorDialog = (
	props: VoiceSelectorDialogProps
) => <CommandDialog {...props} />

export type VoiceSelectorInputProps = ComponentProps<
	typeof CommandInput
>
...
export type VoiceSelectorListProps = ComponentProps<
	typeof CommandList
>

export const VoiceSelectorList = (
	props: VoiceSelectorListProps
) => <CommandList {...props} />

export type VoiceSelectorEmptyProps = ComponentProps<
	typeof CommandEmpty
>

export const VoiceSelectorEmpty = (
	props: VoiceSelectorEmptyProps
) => <CommandEmpty {...props} />

export type VoiceSelectorGroupProps = ComponentProps<
	typeof CommandGroup
>

export const VoiceSelectorGroup = (
	props: VoiceSelectorGroupProps
) => <CommandGroup {...props} />

export type VoiceSelectorItemProps = ComponentProps<
	typeof CommandItem
>
...
export const VoiceSelectorShortcut = (
	props: VoiceSelectorShortcutProps
...
export const VoiceSelectorSeparator = (
	props: VoiceSelectorSeparatorProps
) => <CommandSeparator {...props} />

export type VoiceSelectorGenderProps =
	ComponentProps<'span'> & {
		value?:
			| 'male'
			| 'female'
...
export type VoiceSelectorDescriptionProps =
	ComponentProps<'span'>
...
export type VoiceSelectorAttributesProps =
	ComponentProps<'div'>
...
export type VoiceSelectorBulletProps =
	ComponentProps<'span'>
