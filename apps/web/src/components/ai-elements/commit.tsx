...
export type CommitHeaderProps = ComponentProps<
...
export type CommitAuthorAvatarProps = ComponentProps<
	typeof Avatar
> & {
	initials: string
}
...
export type CommitCopyButtonProps = ComponentProps<
	typeof Button
> & {
	hash: string
	onCopy?: () => void
...
export const CommitCopyButton = ({
	...
	const { isCopied, copy } = useCopyToClipboard(hash, {
		timeout,
		onCopy,
		onError
	})
...
export type CommitContentProps = ComponentProps<
...
export type CommitFileIconProps = ComponentProps<
	typeof FileIcon
>
