...
export const MessageContent = ({
	...
	<div
		className={cn(
			'flex w-fit min-w-0 max-w-full flex-col overflow-hidden text-sm text-foreground',
...
export const MessageBranchContent = ({
	...
	const { currentBranch, setBranches, branches } =
		useMessageBranch()
...
export const MessageBranchPage = ({
	...
	const { currentBranch, totalBranches } =
		useMessageBranch()
...
export type StreamingMessageResponseProps = Omit<
