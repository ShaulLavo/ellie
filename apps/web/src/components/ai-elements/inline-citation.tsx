...
const CarouselApiContext = createContext<
...
export const InlineCitationCarouselIndex = ({
	...
	useEffect(() => {
		...
		setCount(api.scrollSnapList().length) // eslint-disable-line react-hooks/set-state-in-effect -- sync init from carousel API
