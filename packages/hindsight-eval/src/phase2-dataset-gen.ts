...
const ENTITIES = [
  ...
  "Acme Corp", "TechStart", "GlobalInc", "FoodCo", "BuildIt",
  "New York", "San Francisco", "London", "Tokyo", "Berlin",
  "Project Alpha", "Project Beta", "Project Gamma", "Project Delta", "Project Epsilon",
]

const ATTRIBUTES = [
  "role", "department", "location", "status", "preference",
  "category", "priority", "type", "stage", "sentiment",
]
